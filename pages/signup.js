...
const Signup = () => {
  ...
  const ValidationSchema = Yup.object().shape({
    name: Yup.string()
      .min(2, "Name must conatin at least 2 character")
                ...
                <Form className="w-full max-w-lg">
                  ...
                  <div className="flex flex-wrap -mx-3 mb-6">
                    ...
                    <div className="w-full px-3">
                      ...
                      <Field name="password" className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password" type="password" placeholder="Enter Password" />
                    ...
                    <div className="w-full px-3">
                      ...
                      <Field name="cpassword" className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password" type="password" placeholder="Enter Password again" />
                      <div className="text-red-500 "><ErrorMessage name="cpassword" /></div>

                    </div>
                    <div className="w-full px-3">
                      <button type='submit' className=" w-full flex mr-2 justify-center text-white bg-pink-500 border-0 py-2 px-2 focous:outline-none hover:bg-pink-600 rounded text-sm" >Sign up</button>
